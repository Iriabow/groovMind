"""
Django settings for groovMind project.
...
SECRET_KEY = 'q7@vj(p#59i)9&*q3^8o0=rr&r6l()k!lt&)%-hhe#!0$t8ft-'
...
WSGI_APPLICATION = 'groovMind.wsgi.application'
